...
[Part
1](https://frankhjung.blogspot.com/2026/01/thoughts-on-rng-bash-scripting.html)
of this series explored pseudo-random values—statistically random values derived
from a known starting point. This article explores using random values in
testing. Randomness in test invocation is common; for instance,
...
* [Source for this article](https://github.com/frankhjung/article-markdown/)
  (GitHub)
